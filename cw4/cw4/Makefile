...
ifeq ($(config),debug_x64)
  ...
  cw4_config = debug_x64
  cw4_shaders_config = debug_x64
  cw4_bake_config = debug_x64
  ...
  cw4_config = release_x64
  cw4_shaders_config = release_x64
  cw4_bake_config = release_x64
...
PROJECTS := x-volk x-vulkan-headers x-stb x-glfw x-vma x-glm x-rapidobj x-tgen x-zstd cw4 cw4-shaders cw4-bake labutils
...
cw4: labutils x-volk x-stb x-glfw x-vma cw4-shaders x-glm
ifneq (,$(cw4_config))
	@echo "==== Building cw4 ($(cw4_config)) ===="
	@${MAKE} --no-print-directory -C cw4 -f Makefile config=$(cw4_config)
endif

cw4-shaders:
ifneq (,$(cw4_shaders_config))
	@echo "==== Building cw4-shaders ($(cw4_shaders_config)) ===="
	@${MAKE} --no-print-directory -C cw4/shaders -f Makefile config=$(cw4_shaders_config)
endif

cw4-bake: labutils x-tgen x-zstd x-glm x-rapidobj
ifneq (,$(cw4_bake_config))
	@echo "==== Building cw4-bake ($(cw4_bake_config)) ===="
	@${MAKE} --no-print-directory -C cw4-bake -f Makefile config=$(cw4_bake_config)
endif
...
clean:
	...
	@${MAKE} --no-print-directory -C cw4 -f Makefile clean
	@${MAKE} --no-print-directory -C cw4/shaders -f Makefile clean
	@${MAKE} --no-print-directory -C cw4-bake -f Makefile clean
